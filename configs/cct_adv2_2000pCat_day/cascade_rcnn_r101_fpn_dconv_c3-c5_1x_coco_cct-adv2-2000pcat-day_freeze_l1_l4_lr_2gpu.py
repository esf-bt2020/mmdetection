...
classes = ('opossum', 'racoon', 'squirrel', 'bobcat', 'dog', 'coyote', 'rabbit', 'bird', 'cat', 'car', 'deer', 'fox') #12 classes
...
data = dict(
	...
	img_prefix='/media/SSD2project/WilLiCam/datasets/caltech/cct_images',
        classes=classes,
        ann_file='customDataCaltech/adv2_2000pcat_day/adv2_2000pcat_day_train.json'),
    val=dict(
    	type='CocoDataset',
        #img_prefix='/media/Pool/Thesis/Datensets/cct_images',
	#img_prefix='/home/felice/Datasets/cct_images',
	img_prefix='/media/SSD2project/WilLiCam/datasets/caltech/cct_images',
        classes=classes,
        ann_file='customDataCaltech/adv2_2000pcat_day/adv2_2000pcat_day_val.json'),
    test=dict(
    	type='CocoDataset',
	#img_prefix='/home/felice/Datasets/cct_images',
        #img_prefix='/media/Pool/Thesis/Datensets/cct_images',
...
work_dir = '/media/SSD2project/WilLiCam/checkpoint_workdir/cascade_rcnn_r101_fpn_dconv_c3-c5_1x_coco_cctadv2_2000pCat_day_LR2gpu'

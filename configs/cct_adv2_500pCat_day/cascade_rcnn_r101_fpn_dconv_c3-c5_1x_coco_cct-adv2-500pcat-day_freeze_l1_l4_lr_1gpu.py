...
data = dict(
    train=dict(
 	...
 	img_prefix='/home/felice/Datasets/cct_images',
        classes=classes,
        ann_file='customDataCaltech/adv2_500pcat_day/adv2_500pcat_day_train.json'),
    val=dict(
    	type='CocoDataset',
        #img_prefix='/media/Pool/Thesis/Datensets/cct_images',
	img_prefix='/home/felice/Datasets/cct_images',
        classes=classes,
        ann_file='customDataCaltech/adv2_500pcat_day/adv2_500pcat_day_val.json'),
    test=dict(
    	type='CocoDataset',
	img_prefix='/home/felice/Datasets/cct_images',
        #img_prefix='/media/Pool/Thesis/Datensets/cct_images',
        classes=classes,
        ann_file='customDataCaltech/adv2_500pcat_day/adv2_500pcat_day_test.json'))

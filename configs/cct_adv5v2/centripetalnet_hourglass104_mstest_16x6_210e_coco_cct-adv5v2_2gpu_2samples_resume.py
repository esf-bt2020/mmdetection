...
data = dict(
	samples_per_gpu=2, #default 6
	workers_per_gpu=2, #default 3
...
optimizer = dict(type='SGD', lr=0.0016, momentum=0.9, weight_decay=0.0001) #2 GPUs => 2*2=4 => 4/48= 1/12 cheetah
...
resume_from = 'checkpoints/centripetalnet_cct-adv5v2_ep69.pth'

work_dir = '/media/storage1/projects/WilLiCam/checkpoint_workdir/centripetalnet_hourglass104_mstest_16x6_210e_coco_cct-adv5v2_2gpu_2samples_resume'

...
optimizer = dict(type='SGD', lr=0.0025, momentum=0.9, weight_decay=0.0001) #cheetah (2x2=4) LowLR

evaluation = dict(classwise=True, interval=1, metric='bbox')

#work_dir = '/media/SSD2project/WilLiCam/checkpoint_workdir/detectorsR50_cct_adv5_coco'
work_dir = '/media/storage1/projects/WilLiCam/checkpoint_workdir/detectors_cascade_rcnn_r50_1x_coco_cct-adv5v2_nofreeze_lr_2gpu_lowLR'

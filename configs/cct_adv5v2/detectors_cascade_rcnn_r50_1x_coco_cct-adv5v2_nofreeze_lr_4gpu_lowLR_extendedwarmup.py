...
optimizer = dict(type='SGD', lr=0.005, momentum=0.9, weight_decay=0.0001) #4GPUS => (4x2=8) lowLR 1/2 von 0.01
...
work_dir = '/media/storage1/projects/WilLiCam/checkpoint_workdir/detectors_cascade_rcnn_r50_1x_coco_cct-adv5v2_nofreeze_lr_4gpu_lowLR_extendedwarmup'

total_epochs = 30 #default=12

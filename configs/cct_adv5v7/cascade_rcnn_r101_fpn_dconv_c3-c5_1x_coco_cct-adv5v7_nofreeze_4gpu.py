...
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001) # 4 GPUs (4x2=8)
...
work_dir = '/media/storage1/projects/WilLiCam/checkpoint_workdir/cascade_rcnn_r101_fpn_dconv_c3-c5_1x_coco_cct-adv5v7_nofreeze_4gpu'

...
python tools/test.py $modelConfig $fileEpoch --show-dir $outputfoldertrans --cfg-options data.test.ann_file=$fileAnnotationsTransTest --eval bbox > "${folderModel}/test_trans_best_ep${bestEpochTrans}.log"

...
python tools/test.py $modelConfig $fileEpoch --show-dir $outputfolderknown --cfg-options data.test.img_prefix="customDataTestFuchsEmpty/images_person" data.test.ann_file="customDataTestFuchsEmpty/210304_CCT_Human_COCO.json" --eval bbox > "${folderModel}/test_raubtierv2b_testperson_best_ep${bestEpoch}.log"

...
{
    public class Adv5v4_withEmptybbox
    {
        private Coco _full;

        public Adv5v4_withEmptybbox(string full)
        {
        ...
        public void AddEmptyPictures()
        {
            ...
            string targetPath = @"C:\Work\Github\esf-bt2020_mmdetection\customDataCaltech\adv5v4";



            AppendImages(sourcePath, targetPath, "adv5_train.json", "adv5v4_train.json", knowntrainImages);
            AppendImages(sourcePath, targetPath, "adv5_known_val.json", "adv5v4_known_val.json", knownvalImages);
            AppendImages(sourcePath, targetPath, "adv5_known_test.json", "adv5v4_known_test.json", knowntestImages);
            
            AppendImages(sourcePath, targetPath, "adv5_trans_val.json", "adv5v4_trans_val.json", transValImages);
            AppendImages(sourcePath, targetPath, "adv5_trans_test.json", "adv5v4_trans_test.json", transTestImages);

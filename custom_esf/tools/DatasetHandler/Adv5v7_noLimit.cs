...
namespace DatasetHandler
{
    public class Adv5v7_noLimit
    {
        ...
        public static void SplitAnnotationFile(string path)
        {
            ...
            Dictionary<long, Adv5v7_DatasetHandler> animalStatistics = new Dictionary<long, Adv5v7_DatasetHandler>();
            ...
            foreach (var annotations in deserialized.annotations)
            {
                ...
                if (!Adv5v7_DatasetHandler.IsAnimalRelevant(annotations.category_id))
                {
                ...
                if (allImages.TryGetValue(annotations.image_id, out image))
                {
                    ...
                    string type = Adv5v7_DatasetHandler.GetTargetDatasetOfImage(image);
                    ...
                    {
                        Adv5v7_DatasetHandler statistics = new Adv5v7_DatasetHandler();
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv5v7_train.json", serialized);

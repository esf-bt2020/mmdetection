...
{
    public class GenerateSplitDay1000_adv2
    {
        ...
        public static void SplitAnnotationFile(string path)
        {
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv2_1000pcat_day_train.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv2_1000pcat_day_val.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv2_1000pcat_day_test.json", serialized);

...
{
    public class GenerateSplitDay1000_adv3
    {
        //14 classes
        ...
        private const int _MaxImagesPerCategory = 1000;
        ...
        public static void SplitAnnotationFile(string path)
        {
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_1000pcat_day_train.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_1000pcat_day_val.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_1000pcat_day_test.json", serialized);

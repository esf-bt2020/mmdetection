...
{
    public class GenerateSplitDay2000_adv4
    {

        //14 classes
        private static List<long> _CategoriesToUse = new List<long>() { 3, 5, 6, 8, 9, 10, 11, 16, 33, 34, 51 };

        private static List<long> _LocationsNotForTrain = new List<long>() { 125, 130, 46, 0, 28, 40, 78, 100, 7, 105 };
        ...
        public static void SplitAnnotationFile(string path)
        {
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_2000pcat_day_train.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_2000pcat_day_val.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_2000pcat_day_test.json", serialized);

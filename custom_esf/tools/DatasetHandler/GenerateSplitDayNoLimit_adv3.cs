...
{
    public class GenerateSplitDayNoLimitadv3
    {
        ...
        private const int _MaxImagesPerCategory = 2000000;
        ...
        public static void SplitAnnotationFile(string path)
        {
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_nolimitpcat_day_train.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_nolimitpcat_day_val.json", serialized);
            ...
            System.IO.File.WriteAllText(outputPath + @"\adv3_nolimitpcat_day_test.json", serialized);
